(function () {
  ...
  var NAV_HTML =
    ...
    '<a href="https://www.f9xr.org/articles/" target="_blank" rel="noopener noreferrer" class="flex gap-4 hover:bg-white/5 p-3 rounded-xl transition-colors group/item border-t border-white/5"><div class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-accent-blue/20 group-hover/item:text-accent-blue transition-colors"><i class="fa-solid fa-blog"></i></div><div class="flex-1"><div class="text-white text-[13px] lg:text-[15px] font-bold mb-0.5">Blog</div><div class="text-platinum/50 text-[10px] leading-snug font-medium">Insights and updates</div></div></a>' +
