(function () {
  ...
  var NAV_HTML =
    ...
    '<a href="https://f9xr.org/articles/" target="_blank" rel="noopener noreferrer" class="flex gap-4 hover:bg-white/5 p-3 rounded-xl transition-colors group/item border-t border-white/5"><div class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-accent-blue/20 group-hover/item:text-accent-blue transition-colors"><i class="fa-solid fa-blog"></i></div><div class="flex-1"><div class="text-white text-[13px] lg:text-[15px] font-bold mb-0.5">Blog</div><div class="text-platinum/50 text-[10px] leading-snug font-medium">Insights and updates</div></div></a>' +
    ...
    '<a href="https://f9xr.org/seo-audit-report-skill" target="_blank" rel="noopener noreferrer" class="flex gap-4 hover:bg-white/5 p-3 rounded-xl transition-colors group/item border-t border-white/5"><div class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-accent-blue/20 group-hover/item:text-accent-blue transition-colors"><i class="fa-solid fa-code-branch"></i></div><div class="flex-1"><div class="text-white text-[13px] lg:text-[15px] font-bold mb-0.5">SEO Codebase Auditor</div><div class="text-platinum/50 text-[10px] leading-snug font-medium">Audit your codebase for SEO</div></div></a>' +
    '<a href="https://f9xr.org/boredpup" target="_blank" rel="noopener noreferrer" class="flex gap-4 hover:bg-white/5 p-3 rounded-xl transition-colors group/item border-t border-white/5"><div class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-accent-blue/20 group-hover/item:text-accent-blue transition-colors"><i class="fa-solid fa-gamepad"></i></div><div class="flex-1"><div class="text-white text-[13px] lg:text-[15px] font-bold mb-0.5">Online Games</div><div class="text-platinum/50 text-[10px] leading-snug font-medium">Play free browser games</div></div></a>' +
    '<a href="https://f9xr.org/dev9b" target="_blank" rel="noopener noreferrer" class="flex gap-4 hover:bg-white/5 p-3 rounded-xl transition-colors group/item border-t border-white/5"><div class="w-10 h-10 lg:w-12 lg:h-12 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover/item:bg-accent-blue/20 group-hover/item:text-accent-blue transition-colors"><i class="fa-solid fa-code"></i></div><div class="flex-1"><div class="text-white text-[13px] lg:text-[15px] font-bold mb-0.5">Developer Blog</div><div class="text-platinum/50 text-[10px] leading-snug font-medium">Build notes and dev logs</div></div></a></div></div></div>' +
    ...
    '<a href="mailto:hello@f9xr.org" aria-label="Email Us" class="text-platinum/70 text-2xl hover:text-white transition-colors"><i class="fa-solid fa-envelope"></i></a>' +
  ...
  var FOOTER_HTML =
    ...
    '<div class="bg-accent-blue py-4 border-y border-white/10 overflow-hidden select-none mb-8 w-full">' +
    ...
    '<div class="flex flex-col md:flex-row justify-between items-center pt-10 pb-10 mb-10 border-b border-white/5 gap-8 reveal">' +
    ...
    '<div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-14">' +
    ...
    '<a href="https://f9xr.org/seo-audit-report-skill" target="_blank" rel="noopener noreferrer" class="flex items-center text-2xl lg:text-[28px] font-bold text-white hover:text-accent-blue transition-colors tracking-tight"><i class="fa-solid fa-code-branch text-accent-blue/50 mr-3 text-xl w-6 text-center"></i>SEO Codebase Auditor</a>' +
    '<a href="https://f9xr.org/boredpup" target="_blank" rel="noopener noreferrer" class="flex items-center text-2xl lg:text-[28px] font-bold text-white hover:text-accent-blue transition-colors tracking-tight"><i class="fa-solid fa-gamepad text-accent-blue/50 mr-3 text-xl w-6 text-center"></i>Online Games</a>' +
    '<a href="https://f9xr.org/dev9b" target="_blank" rel="noopener noreferrer" class="flex items-center text-2xl lg:text-[28px] font-bold text-white hover:text-accent-blue transition-colors tracking-tight"><i class="fa-solid fa-code text-accent-blue/50 mr-3 text-xl w-6 text-center"></i>Developer Blog</a>' +
    '<a href="https://f9xr.org/articles/" target="_blank" rel="noopener noreferrer" class="flex items-center text-2xl lg:text-[28px] font-bold text-white hover:text-accent-blue transition-colors tracking-tight"><i class="fa-solid fa-arrow-up-right-from-square text-accent-blue/50 mr-3 text-xl w-6 text-center"></i>Blog</a></div></div>' +
    ...
    '<a href="mailto:hello@f9xr.org" class="text-3xl md:text-4xl lg:text-5xl font-bold text-white hover:text-accent-blue transition-colors break-all select-all inline-block w-fit tracking-tight">hello@f9xr.org</a>' +
    ...
    '<div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-12">' +
    ...
    '<div class="w-full flex items-center justify-center gap-4 sm:gap-6 lg:gap-8 mb-12 mt-auto">' +
    ...
    '<div class="relative w-full py-6 lg:py-8 border-t border-white/10 overflow-hidden mt-2">' +
