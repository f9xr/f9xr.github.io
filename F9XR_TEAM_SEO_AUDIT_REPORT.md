...
<div class="f9xr-cover">
  ...
  <div class="f9xr-meta" style="position:relative;z-index:1;">
    ...
    <strong>Target Architecture:</strong> <a href="https://f9xr.org">https://f9xr.org</a><br>
...
| **Blog Network** | 82 blog posts @ f9xr.org/articles |
...
This audit was conducted by directly scanning the local repository files at `C:\Users\inanj\OneDrive\Documents\GitHub\f9xr.org`. Every HTML file, stylesheet, JavaScript module, XML sitemap, and configuration file was programmatically inspected for:
...
|---|---|---|---|
| <span class="matrix-hl">1.00</span> | Root / Homepage | 1 | `https://f9xr.org/` |
...
| Canonical Tag | <span class="status-good">PASS</span> | Every page has `<link rel="canonical" href="https://f9xr.org/..." />` |
...
The F9XR Team blog network at `f9xr.org/articles` comprises **82 published posts** organized into two categories:
...
**Interlinking Recommendation:** Add contextual blog references from the F9XR site to relevant blog posts. For example, link `pages/services.html` to `f9xr.org/articles/.../google-business-profile-optimization.html` under the "Google Business Profile" service card.
...
| All pages (Footer) | Footer | Generic "Blog" link | `f9xr.org/articles/.../google-business-profile-optimization.html` | "Latest: Google Business Profile Optimization" | Update footer blog link to point to latest post |
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://f9xr.org/" },
    { "@type": "ListItem", "position": 2, "name": "Services", "item": "https://f9xr.org/pages/services.html" },
    { "@type": "ListItem", "position": 3, "name": "AI Visibility Optimization", "item": "https://f9xr.org/services/ai-visibility-optimization.html" }
  ]
}
</script>
```
  ...
  "@graph": [
    {
      ...
      "itemReviewed": { "@type": "Organization", "name": "F9XR Team", "url": "https://f9xr.org/" },
      "reviewBody": "...",
...
| `Product` / `SoftwareApplication` (blog) | External | `f9xr.org/articles` posts | Product Snippets |
...
**Recommendation:** Add stable `@id` anchors to all top-level entities (e.g., `"@id": "https://f9xr.org/#faq"`) for cross-referencing within the knowledge graph. This is not a ranking factor but improves graph connectivity for Google's Knowledge Vault.
...
| | Technical blog network (82 posts) | `f9xr.org/articles` | <span class="status-good">STRONG</span> |
...
| 4 | `canonical` / `og:url` on homepage | `https://f9xr.org/index.html` | Mismatch with sitemap root `/` | <span class="severity-fixed">FIXED</span> &mdash; now `https://f9xr.org/` |
...
### 13.2 Blog Link Migration (`growwithguidance.blogspot.com` &rarr; `f9xr.org/articles`)

| Item | Before | After | Status |
|---|---|---|---|
| Legacy outbound links | `https://growwithguidance.blogspot.com/...` across 9 files | All 161 references migrated to `https://f9xr.org/articles/...` (incl. 65 deep article links) | <span class="severity-fixed">FIXED</span> |
| Homepage recent-posts feed widget | Blogger feed URL | Now points to `https://f9xr.org/articles/feeds/posts/...` &mdash; will error until the articles site exposes the feed | <span class="status-warn">CAVEAT</span> |
...
<div style="background:#131418;color:#ffffff;padding:30px;border-radius:12px;margin:40px 0;text-align:center;">
  ...
  <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;">
    <a href="https://f9xr.org" style="display:inline-block;background:#582b8c;color:#ffffff;padding:12px 30px;border-radius:6px;font-weight:700;font-size:11pt;">Visit Our Website</a>
...
*Sep 2026 reconciliation: directories audit fixes applied, blog links migrated to f9xr.org/articles, AI Tools directory launched (51-URL sitemap)*
