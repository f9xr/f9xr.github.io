# F9XR Team — [https://f9xr.org](https://f9xr.org)

> Architects of Digital Precision

Global digital agency specializing in high-performance web development, AI-powered SEO, and brand growth. This repository powers our live GitHub Pages static site.

## What's Here

- **Homepage** (`index.html`) — Landing page with services overview, process, pricing, and portfolio
- **Services** (`pages/services.html`, `services/*.html`) — Web design, SEO, GBP management, email setup, AI visibility, data management, website rentals, Indian professionals
...
- **Forms**: Formspree
- **Hosting**: GitHub Pages (no build step — pure static)
